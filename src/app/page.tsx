      ...
      <div className="flex flex-col min-h-screen">
        ...
        <section className="relative -mt-12 w-full h-screen flex items-center justify-center text-center text-white overflow-hidden">
          ...
          <div className="relative z-20 p-4 md:p-8 max-w-4xl mx-auto">
            <div className="animate-in fade-in-0 slide-in-from-bottom-12 duration-1000 delay-100">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6 animate-in fade-in-0 slide-in-from-bottom-10 duration-1000 delay-200">
              <Button
                asChild
                size="lg"
        ...
        <SectionWrapper className="bg-card text-foreground py-16 md:py-24">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="animate-in fade-in-0 slide-in-from-left-10 duration-500 delay-100">
            ...
            <div className="animate-in fade-in-0 slide-in-from-right-10 duration-500 delay-200">
        ...
        <SectionWrapper title="Why Choose Himalaya?" className="bg-background text-foreground py-16 md:py-24">
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              { title: "Holistic Development", icon: Leaf, description: "We focus on the all-round development of students, including arts, sports, and life skills.", delay: 200 },
              { title: "Vibrant Community", icon: Users, description: "A supportive and inclusive community where every student feels valued and can thrive.", delay: 300 }
            ].map((item, index) => (
              <Card key={index} className="shadow-xl hover:shadow-2xl transition-all duration-300 bg-card hover:border-primary/50 group animate-in fade-in-0 slide-in-from-bottom-5 duration-500" style={{ animationDelay: `${item.delay}ms`}}>
        ...
        <SectionWrapper title="Our Programs" className="bg-card text-foreground py-16 md:py-24">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { title: "Primary School", description: "Grades 1-5. Building strong foundations in a nurturing environment.", icon: BookOpenCheck, href: "/academic-programs#primary", delay: 100, dataAiHint: "children classroom" },
              { title: "Middle School", description: "Grades 6-8. Fostering critical thinking and deeper subject understanding.", icon: TrendingUp, href: "/academic-programs#middle", delay: 150, dataAiHint: "students science" },
              { title: "High School", description: "Grades 9-12. Preparing for board exams and future career paths.", icon: ShieldCheck, href: "/academic-programs#high", delay: 200, dataAiHint: "teenagers studying" },
              { title: "Tech Programs", description: "Specialized courses in Coding, Robotics, and Computer Literacy.", icon: Zap, href: "/tech-programs", delay: 250, dataAiHint: "robotics coding" },
            ].map((program) => (
              <Card key={program.title} className="group overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 flex flex-col h-full bg-background hover:border-accent/50 animate-in fade-in-0 slide-in-from-bottom-5 duration-500" style={{ animationDelay: `${program.delay}ms`}}>
        ...
        <SectionWrapper title="Vibrant School Life" className="bg-background text-foreground py-16 md:py-24">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { title: "Sports & Athletics", icon: Activity, description: "Promoting fitness, teamwork, and sportsmanship through various sports.", delay: 100, dataAiHint:"students playing sports" },
              { title: "Arts & Culture", icon: Palette, description: "Encouraging creativity through music, dance, drama, and visual arts.", delay: 200, dataAiHint:"children painting art" },
              { title: "Clubs & Events", icon: Telescope, description: "From science fairs to debate clubs, there's something for every interest.", delay: 300, dataAiHint:"student clubs activity" },
            ].map((item) => (
               <Card key={item.title} className="bg-card shadow-lg rounded-lg p-6 text-center group hover:shadow-xl transition-shadow duration-300 animate-in fade-in-0 slide-in-from-bottom-5 duration-500" style={{animationDelay: `${item.delay}ms`}}>
        ...
        <footer className="bg-primary text-primary-foreground py-12 md:py-16 mt-10">
          <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-3 gap-10 mb-10">
              ...
              <div className="animate-in fade-in-0 slide-in-from-bottom-5 duration-500 delay-50">
              ...
              <div className="animate-in fade-in-0 slide-in-from-bottom-5 duration-500 delay-150">
