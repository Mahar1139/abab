          ...
          <div className="relative z-20 p-4 md:p-8 max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6 animate-in fade-in-0 slide-in-from-bottom-10 duration-1000 delay-500">
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="w-full sm:w-auto px-10 py-7 text-lg font-semibold shadow-xl hover:scale-105 transition-transform duration-300 border-2 bg-transparent text-primary border-primary dark:text-white dark:border-white"
              >
