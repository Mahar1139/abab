...
- If difficulty is "Abki Baar 720 Paar!":
...
- If difficulty is "Normal - SBI PO Prelims":
  For topic "{{topic}}" (expected to be Mathematics, Quantitative Aptitude, Reasoning Ability, or English Language), generate a question of truly "Normal" difficulty for a competitive banking exam aspirant, in the style and format of SBI PO (State Bank of India Probationary Officer) Preliminary Exam. The question must be a single correct multiple-choice question. The source should be "SBI PO Prelims-style Question ({{topic}} based)". The questions should be inspired by the type of concepts tested in previous year SBI PO Prelims question papers and patterns found in well-known SBI PO preparation books (e.g., books by R.S. Aggarwal, Arun Sharma, or Arihant publications for conceptual style). Furthermore, ensure that approximately 60% of these questions draw significant inspiration from the question styles, patterns, and content found in popular SBI PO preparation resources such as those from Adda, PW, and Quanta. Focus on core understanding suitable for a preliminary exam, but ensure it is not overly simplistic and genuinely tests the aptitude of a banking aspirant. The question should require careful thought and not be solvable by trivial recall.
- If difficulty is "Legend - SBI PO Mains":
  For topic "{{topic}}" (expected to be Mathematics, Quantitative Aptitude, Reasoning Ability, English Language, or Banking & Financial Awareness), generate a question similar in style and complexity to the SBI PO Mains Exam. The question must be a single correct multiple-choice question, potentially involving data interpretation, critical reasoning, or deeper application of concepts. The source should be "SBI PO Mains-style Question ({{topic}} based)". These questions must be significantly challenging, reflecting the advanced nature of the SBI PO Mains exam. They should test deep analytical skills, complex problem-solving, and nuanced understanding. Avoid trivial questions; make them genuinely difficult. Ensure plausible and highly challenging distractors. Questions should be inspired by previous year SBI PO Mains papers and advanced concepts covered in top-tier preparation books for the Mains level. Furthermore, ensure that approximately 60% of these questions draw significant inspiration from the question styles, patterns, and content found in popular SBI PO preparation resources such as those from Adda, PW, and Quanta.
